...
const TABS = [
  ...
  { label: "Stocks",     tickers: [{ ticker: "TSLA", name: "Tesla" }, { ticker: "AAPL", name: "Apple" }, { ticker: "NVDA", name: "nVidia" }, { ticker: "META", name: "Meta" }, { ticker: "GOOGL", name: "Alphabet" }, { ticker: "NFLX", name: "Netflix" }] },
